...
Note that this is related to the problem of \emph{deadline-scheduling-on-intervals} introduced by~\cite{antoniadis}. 



\section{Algorithm}
\todo{How to replace the term \emph{activation}? Candidates: start-of-work.}
\todo{Formal Problem definition, notation}
\todo{Formulate and format keepbusy, keepidle nicer.}
