...
\todo{Cite~\cite{irani_pruhs_pose_problem} for problem relevance as Antoniadis does?
...
\todo{Mention that in their conclusion, they pose the multi-processor setting with general jobs as a natural generalization of the problem, as this was also an ESA paper? Beware: they already mention~\cite{demaine} here.}
