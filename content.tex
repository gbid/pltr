...
\todo[inline]{Rename problem \emph{deadline scheduling with lower and upper processor bounds} since we are only using it for feasibility?}
...
\todo[inline]{Write some text that this resembles the proof for $\LTR$ together with an argument that realignment cannot decrease costs. Alternatively: just remove the subsection?}
\todo[inline]{Think about what to do with this ``ending before $d^*$ restriction.}
\todo[inline]{Merge Lemma~\ref{lemma:costs_s_real} and Theorem~\ref{theorem:approximation}}
