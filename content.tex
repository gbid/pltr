...
\begin{lemma}\label{lemma:critical}
  ...
  \end{align}
  For every engagement $t$ of some processor $k \in [m]$ in $S_{\pltr}$, there exists a tight set $Q_t \subseteq T$ for engagement $t$ of processor $k$.
\end{lemma}
\begin{proof}
...
\begin{proof}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.25\textwidth]{graphics/egagements.jpg}
