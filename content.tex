...
\end{theorem}
\begin{proof}
  The algorithm only modifies the upper and lower bounds $m_t, l_t$ for the number of busy processors such that the resulting instance of \emph{power-down scheduling with lower and upper bounds} remains feasible.
  The correctness of the algorithm then follows from Lemma~\ref{lemma:flow_feasibility}.
\end{proof}
