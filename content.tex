...
Obtaining good solutions for multiple processors and general job weights is difficult because of the additional constraint that every job can be worked on by at most a single processor at the same time.
...
Their algorithm obtains a possibly infeasible integer solution by building the convex hull of the corresponding fractional LP solution.
...
\subsubsection{Costs of busy and idle intervals}
