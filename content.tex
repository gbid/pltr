...
While the algorithm we develop in Section~\ref{section:algorithm} is very simple and the structure exhibited by the resulting schedules is surprisingly rich, the analysis is highly non-trivial.
...
We say a processor is \emph{busy} at time $t \in T$ if some job is scheduled on this processor at time $t$.
