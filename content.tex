...
\end{lemma}
\begin{proof}
  By Lemma~\ref{lemma:activation} and $\crit(A_r) \leq 1$, we know that $\min A_r$ is an activation of processor $1$ in $S_{\aug}$.
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{graphics/sketches/constellation.png}\label{fig:constellation}
    \caption{}
  \end{figure}
