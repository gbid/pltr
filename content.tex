...
\begin{proof}
  ...
  \paragraph{Case 1:}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{graphics/invariant_case1.jpg}\label{fig:invariant_case1}
...
\begin{proof}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{graphics/running_time.jpg}\label{fig:running_time}
    \caption{}
  \end{figure}
