...
\begin{figure}[H]
  ...
  \end{tikzpicture}
  \caption{The Flow-Network for checking feasibility of an instance of \emph{deadline-scheduling-with-lower-and-upper-processors-bounds} $l_t$ and $m_t$ for the number of busy processors at $t \in T$.
